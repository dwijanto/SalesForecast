...
Public Class FormCMMFMY
    ...
    Public Sub New()
        ...
        RemoveHandler DialogCMMFMY.RefreshDataGridView, AddressOf RefreshDataGridView
        AddHandler DialogCMMFMY.RefreshDataGridView, AddressOf RefreshDataGridView
    End Sub
    ...
    Sub DoWork()
        myController = New CMMFMYController
    ...
    Public Sub showTx(ByVal tx As TxEnum)
        If Not myThread.IsAlive Then
            ...
            Dim myform = New DialogCMMFMY(drv, ProductLine)
            myform.ShowDialog()
        End If
    ...
    Private Sub ToolStripButton6_Click(sender As Object, e As EventArgs) Handles ToolStripButton6.Click
        Dim mytemplate As New CMMFMYExport
    ...
    Private Sub DoImport()
        Try
                                    ...
                                    myInsert.Append(PostgreSQLDbAdapter.validlong(myrecord(0)) & vbTab &
                                          ...
                                          PostgreSQLDbAdapter.validstr(myrecord(2)) & vbTab &
                                                ...
                                                PostgreSQLDbAdapter.validstr(myrecord(4)) & vbTab &
                                                 ...
                                                 PostgreSQLDbAdapter.validnumeric(myrecord(6).Replace(",", "")) & vbCrLf)
                                Catch ex As Exception
            ...
            If myInsert.Length > 0 Then
                ...
                mystr.Append(String.Format("delete from sales.sfcmmfms"))
                Dim sqlstr As String = "copy sales.sfcmmfms(cmmf,productline,familylvl2,description,discount,launch,rsp)  from stdin with null as 'Null';"
                Dim ra As Long = 0
