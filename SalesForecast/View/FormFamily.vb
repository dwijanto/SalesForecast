...
Public Class FormFamily
    ...
    Dim ProductLineBS As BindingSource
    ...
    Public Sub New()
        ...
        RemoveHandler DialogFamily.RefreshDataGridView, AddressOf RefreshDataGridView
        AddHandler DialogFamily.RefreshDataGridView, AddressOf RefreshDataGridView
    End Sub
    ...
    Public Sub showTx(ByVal tx As TxEnum)
        If Not myThread.IsAlive Then
            ...
            Dim myform = New DialogFamily(drv, ProductLineBS)
            myform.ShowDialog()
        End If
        ...
        Else
            Select Case id
                ...
                Case 4
                    ...
                    ProductLineBS = New BindingSource
                    ProductLineBS.DataSource = myController.DS.Tables(1)
            End Select
        End If
    End Sub
    ...
    Private Sub DataGridView1_DataError(sender As Object, e As DataGridViewDataErrorEventArgs) Handles DataGridView1.DataError
        MessageBox.Show(String.Format("{0}. Adding record cancelled.", DirectCast(e.Exception, System.Data.NoNullAllowedException).Message))
    End Sub
End Class