...
Public Class FormSalesDeductionTW
    Dim myThread As New System.Threading.Thread(AddressOf DoWork)
    Dim myController As GroupSDController
    ...
    Public Sub New()
        ...
        RemoveHandler DialogSalesDeduction.RefreshDataGridView, AddressOf RefreshDataGridView
        AddHandler DialogSalesDeduction.RefreshDataGridView, AddressOf RefreshDataGridView
    End Sub
    ...
    Sub DoWork()
        myController = New GroupSDController
    ...
    Public Sub showTx(ByVal tx As TxEnum)
        If Not myThread.IsAlive Then
            ...
            Dim myform = New DialogSalesDeduction(drv, GroupBS)
            myform.ShowDialog()
        End If
