...
Public Class FormGrossSalesTW
    Dim myThread As New System.Threading.Thread(AddressOf DoWork)
    Dim myController As GrossSalesTWController
    ...
    Public Sub New()
        ...
        RemoveHandler DialogGrossSalesTW.RefreshDataGridView, AddressOf RefreshDataGridView
        AddHandler DialogGrossSalesTW.RefreshDataGridView, AddressOf RefreshDataGridView
    End Sub
    ...
    Sub DoWork()
        myController = New GrossSalesTWController
    ...
    Public Sub showTx(ByVal tx As TxEnum)
        If Not myThread.IsAlive Then
            ...
            Dim myform = New DialogGrossSalesTW(drv, GroupBS, KAMBS)
            myform.ShowDialog()
        End If
