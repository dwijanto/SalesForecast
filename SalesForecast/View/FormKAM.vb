...
Public Class FormKAM
    ...
    Dim myController As KAMController
    ...
    Public Sub New()
        ...
        RemoveHandler DialogKAM.RefreshDataGridView, AddressOf RefreshDataGridView
        AddHandler DialogKAM.RefreshDataGridView, AddressOf RefreshDataGridView
    End Sub
    ...
    Sub DoWork()
        myController = New KAMController
