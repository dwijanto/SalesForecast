Public Class FormForecastGroupTW
    Dim KAMBS As BindingSource
    Delegate Sub ProgressReportDelegate(ByVal id As Integer, ByVal message As String)

    Dim mytemplate As New ForecastGroupTemplateTW
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        mytemplate.Generate(Me, New FGTemplateTWEventArgs With {.startPeriod = DateTimePicker1.Value.Date, .userName = drv.Item("username"), .blanktemplate = CheckBox1.Checked, .ExRate = exRate})
    End Sub
    ...
    Public Sub New()
        ...
        If Identitiy.isAdmin Then
            KAMController.loaddata(String.Format("where u.location = 2 and isactive"))

        Else
            KAMController.loaddata(String.Format("where u.location = 2 and userid = '{0}'", Identitiy.username))
        End If
        ...
        exRate = TBParamDetailController1.Model.getCurrency(country.TW, "EX-Rate")
...
Public Class FGTemplateTWEventArgs
    Inherits EventArgs
