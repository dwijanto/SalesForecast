...
Public Class FormMLACardNameSD
    Dim myThread As New System.Threading.Thread(AddressOf DoWork)
    Dim myController As MLACardController
    ...
    Public Sub New()
        ...
        RemoveHandler DialogMLA.RefreshDataGridView, AddressOf RefreshDataGridView
        AddHandler DialogMLA.RefreshDataGridView, AddressOf RefreshDataGridView
    End Sub
    ...
    Sub DoWork()
        myController = New MLACardController
