...
Public Class DialogCMMFSG
    ...
    Public Sub New(ByVal drv As DataRowView, ByRef ProductLine As AutoCompleteStringCollection, ByRef Brand As AutoCompleteStringCollection, ByRef FamilyLvl2 As AutoCompleteStringCollection)
        InitializeComponent()
        Me.DRV = drv
    ...
    Private Sub initData()
        ...
        TextBox4.AutoCompleteCustomSource = Brand
        ...
        TextBox4.DataBindings.Add(New Binding("Text", DRV, "brand", True, DataSourceUpdateMode.OnPropertyChanged, ""))
        TextBox5.DataBindings.Add(New Binding("Text", DRV, "description", True, DataSourceUpdateMode.OnPropertyChanged, ""))
        TextBox6.DataBindings.Add(New Binding("Text", DRV, "soh", True, DataSourceUpdateMode.OnPropertyChanged, ""))
        TextBox7.DataBindings.Add(New Binding("Text", DRV, "status", True, DataSourceUpdateMode.OnPropertyChanged, ""))
        TextBox8.DataBindings.Add(New Binding("Text", DRV, "pi2status", True, DataSourceUpdateMode.OnPropertyChanged, ""))
        TextBox9.DataBindings.Add(New Binding("Text", DRV, "rsp", True, DataSourceUpdateMode.OnPropertyChanged, "", "#,##0.00########"))
