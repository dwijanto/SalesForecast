...
Public Class FormMYBudget
    Dim myThread As New System.Threading.Thread(AddressOf DoWork)
    Dim myController As New KAMBudgetController
    Dim KAMController1 As New KAMController
    ...
    Public Sub New()
        ...
        RemoveHandler DialogKAMBudget.RefreshDataGridView, AddressOf RefreshDataGridView
        AddHandler DialogKAMBudget.RefreshDataGridView, AddressOf RefreshDataGridView
    End Sub
    ...
    Sub DoWork()
        ...
        myController = New KAMBudgetController
        ...
        Try
            ...
            End If
            KamList = KAMController1.Model.PopulateKAM(LocationEnum.Malaysia)
            GroupList = GroupController1.Model.PopulateGroupList(LocationEnum.Malaysia)
    ...
    Public Sub showTx(ByVal tx As TxEnum)
        If Not myThread.IsAlive Then
            ...
            Dim myform = New DialogKAMBudget(drv, KamList, GroupList)
            myform.ShowDialog()
        End If
