Public Class CMMFKAMAssignmentController
    Implements IController
    Implements IToolbarAction

    Public Model As New CMMFKAMAssignmentModel
    ...
    Public Function loaddata() As Boolean Implements IController.loaddata
        ...
        Model = New CMMFKAMAssignmentModel
        DS = New DataSet
        If Model.LoadData(DS) Then
            Dim pk(1) As DataColumn
            pk(0) = DS.Tables(0).Columns("kamassignmentid")
            pk(1) = DS.Tables(0).Columns("cmmf")
