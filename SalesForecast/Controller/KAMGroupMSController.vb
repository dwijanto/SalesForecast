Public Class KAMGroupMSController
    Implements IController
    Public Model As New KAMGroupMSModel
    Dim ListModel As New List(Of KAMGroupMSModel)
    ...
    Public Function loaddata() As Boolean Implements IController.loaddata
        ...
        Return myret
    End Function
    Public Function getAssignments(ByVal Criteria As String) As List(Of KAMGroupMSModel)
        Dim myret As Boolean = False
        Model = New KAMGroupMSModel
        ListModel = Model.PopulateKAMGroupMS(Criteria)
        Return ListModel
    End Function
