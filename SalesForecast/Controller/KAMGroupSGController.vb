Public Class KAMGroupSGController
    Implements IController
    Public Model As New KAMGroupSGModel
    Dim ListModel As New List(Of KAMGroupSGModel)
    ...
    Public Function loaddata() As Boolean Implements IController.loaddata
        ...
        Return myret
    End Function
    Public Function getAssignments(ByVal Criteria As String) As List(Of KAMGroupSGModel)
        Dim myret As Boolean = False
        Model = New KAMGroupSGModel
        ListModel = Model.PopulateKAMGroupSG(Criteria)
        Return ListModel
    End Function
