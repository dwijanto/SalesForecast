Public Class SFGroupTXHKController
    Implements IController
    Implements IToolbarAction

    Dim Model As New SFGroupTXHKModel
    ...
    Public Function getRecord(ByVal id As Long) As DataRowView
        Dim itemfound As Integer = BS.Find("id", id)
        If itemfound >= 0 Then
    ...
    Public Function RemoveRecord(ByVal id As Long) As Boolean
        Dim itemfound As Integer = BS.Find("id", id)
        If itemfound >= 0 Then
